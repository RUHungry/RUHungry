					...
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<form id="Ship_Info" disabled＝"true" readonly＝"true">
								<input disabled＝"true" readonly＝"true" id="Ship_First_Name" name="Ship_First_Name" type="text" placehold="First Name" value="<?php echo $_POST['fr_Ship_First_Name'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_Last_Name" name="Ship_Last_Name" type="text" placehold="Last Name" value="<?php echo $_POST['fr_Ship_Last_Name'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_Address1" name="Ship_Address1" type="text" placehold="Address1" value="<?php echo $_POST['fr_Ship_Address1'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_Address2" name="Ship_Address2" type="text" placehold="Address2" value="<?php echo $_POST['fr_Ship_Address2'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_City" name="Ship_City" type="text" placehold="City" value="<?php echo $_POST['fr_Ship_City'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_State" name="Ship_State" type="text" placehold="State" value="<?php echo $_POST['fr_Ship_State'] ?>">
								<input disabled＝"true" readonly＝"true" id="Ship_Zip" name="Ship_Zip" type="text" placehold="Zip" value="<?php echo $_POST['fr_Ship_Zip'] ?>">
							</form>
						</div>
					</div>
						...
						<p>Bill Information</p>
							<div class="form-one">
								<form id="Bill_Info" disabled＝"true" readonly＝"true">
									<input disabled＝"true" readonly＝"true" id="Bill_First_Name" name="Bill_First_Name" type="text" placehold="First Name" value="<?php echo $_POST['fr_Bill_First_Name'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Last_Name" name="Bill_Last_Name" type="text" placehold="Last Name" value="<?php echo $_POST['fr_Bill_Last_Name'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Address1" name="Bill_Address1" type="text" placehold="Address1" value="<?php echo $_POST['fr_Bill_Address1'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Address2" name="Bill_Address2" type="text" placehold="Address2" value="<?php echo $_POST['fr_Bill_Address2'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_City" name="Bill_City" type="text" placehold="City" value="<?php echo $_POST['fr_Bill_City'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_State" name="Bill_State" type="text" placehold="State" value="<?php echo $_POST['fr_Bill_State'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Zip" name="Bill_Zip" type="text" placehold="Zip" value="<?php echo $_POST['fr_Bill_Zip'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Type" name="Bill_Type" type="text" placehold="Card Type" value="<?php echo $_POST['fr_Bill_Type'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Number" name="Bill_Number" type="text" placehold="Card Number" value="<?php echo $_POST['fr_Bill_Number'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Holder" name="Bill_Holder" type="text" placehold="Card Holder" value="<?php echo $_POST['fr_Bill_Holder'] ?>">
									<input disabled＝"true" readonly＝"true" id="Bill_Expire" name="Bill_Expire" type="text" placehold="Expire Date" value="<?php echo $_POST['fr_Bill_Expire'] ?>">
								</form>
							</div>
						</div>
					</div>
