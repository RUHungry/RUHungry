...
if (isset($_POST['submit']))
{
	if($_SESSION["islogin"] == true)
	{
		...
		values ('".$_SESSION["username"]."', 1, now(), ".$_POST['rating'].", '".$_POST['review']."')";
		$add_check = mysql_query($insert) or die("Post review failed.");
		header("Location: customer_reviews.php");
	}
	else
	{
		die("You should login first. <a href=login.php>Click here to login</a> or <a href=".$_SERVER['PHP_SELF'].">Return to previous page</a>");		
	}
}
?>
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								...
								<div class="panel panel-group" >
										 <?php
											include "mysql.php";
											$select = mysql_query("select * from item_reviews where Restrt_ID = 1") or die(mysql_error());
